...
coral_ext <- readr::read_csv(here::here("globalprep", "hab_coral",
                                       ...
                                       "v2021", # temporary hard-coded fix
...
coral_health <- readr::read_csv(here::here("globalprep", "hab_coral",
                                       # paste0("v", (as.numeric(scen_year) - 2)), # error in v2024: most recent update to this folder is 2021... 
                                       "v2021", # temporary hard-coded fix
                                        "data", "habitat_health_coral_updated.csv")) %>% # UPDATE TO MOST RECENT VERSION
  dplyr::select(-c(habitat, year))
...
coral_harvest <- coral_harvest %>%
  ...
  dplyr::select(rgn_id, year, pressure_score = pressure_health) # adds "product" because it's still one of the grouping variable
# come back to this 
...
readr::write_csv(coral_harvest, here::here(current_prs_folder, "output", "prs_coral_harvest.csv"))
```
