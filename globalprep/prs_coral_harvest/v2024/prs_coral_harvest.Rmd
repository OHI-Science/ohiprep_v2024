...
h_tonnes <- read.csv(here::here(current_prs_folder, "int", "tonnes.csv"))

## Read in value dataset from intermediate folder
h_usd <- read.csv(here::here(current_prs_folder, "int", "usd.csv"))
...
readr::write_csv(h_x_tonnes, here::here(current_prs_folder, "int", "coral_harvest_tonnes_wide.csv"), na = "NA")
readr::write_csv(h_x_usd, here::here(current_prs_folder, "int", "coral_harvest_usd_wide.csv"), na = "NA")
```
...
readr::write_csv(roll_prod, here::here(current_prs_folder, "int", "tonnes_coral_harvest.csv"))
```
