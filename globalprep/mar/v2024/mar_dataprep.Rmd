...
mar_raw <- readr::read_csv(file.path(FAO_mariculture_dir, current_data_folder,
...
old_sw_sus <- readr::read_csv(file.path(seafood_watch_dir,
                                 ...
                                 "SFW_Aquaculture_ratings_062222.csv"
                               #  "SFW_Aquaculture_ratings_053123.csv"
...
# 17122 NA values out of 34916 total obs; ~ 49% without scores (2024)
```
...
comp_plot <- ggplot() + 
  geom_point(data = compare, aes(x = prs_score_old, y = pressure_score, text = paste("Region ID:", rgn_id))) +
