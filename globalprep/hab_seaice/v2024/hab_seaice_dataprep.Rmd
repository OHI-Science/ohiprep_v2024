...
source("globalprep/hab_seaice/v2024/ObtainingData.R") ## This has changed (2024) to account for the current working directory being ohiprep_v2024 rather than 'hab_seaice/v2024'
toc()
...
tic()
ref.years <- 1979:2000
source("globalprep/hab_seaice/v2024/Status_Trend.R") # calculates status and trend for shoreline ice and ice edge habitat
toc()
```
