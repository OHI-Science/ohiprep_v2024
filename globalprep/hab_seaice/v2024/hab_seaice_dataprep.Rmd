...
## ATTN! Because this is now done in parallel rather than in sequence (saving ~2hrs of processing time), this script will not display the progress as it does when its sequentially run. Thats okay as long as you check mazu and ensure that the tmp folder is updated about 2 minutes into run-time, and the v2024 folder should have n_rasters_points.rdata and s_rasters_points.rdata populated in about 1.25-1.5 hours. 
