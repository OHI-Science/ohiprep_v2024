...
test <- read_csv(file.path(dir_goal_anx, 'spp_rasters',
                                         sprintf('iucn_sid_%s.csv', spp)))
test2 <- read_csv(file.path("/home/shares/ohi/git-annex/globalprep/spp/v2022/spp_risk_dists", 'spp_rasters',
                                         sprintf('iucn_sid_%s.csv', spp)))
setdiff(test$cell_id, spp_present$cell_id)
```
