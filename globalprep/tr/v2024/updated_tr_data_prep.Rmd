...
dom_acc_guests_coef_gf <- georegions %>% 
  left_join(dom_acc_guests_coef, by = "rgn_id") %>% 
...
dom_acc_guests_gf1 <- dom_acc_guests_agg %>%
  left_join(dom_acc_guests_coef_gf, by = "rgn_id") %>%
  mutate(
    ...
    tourism_arrivals_ct = case_when(
      ...
      is.na(total_guests) & !is.na(hotel_guests) & is.na(total_guests_intercept) & !is.na(total_guests_intercept_r2) ~ (hotel_guests*total_guests_slope_r2) + total_guests_intercept_r2, # if regional lm coefficients weren't possible, go to r2 which is second least specific, then r1
      is.na(total_guests) & !is.na(hotel_guests) & is.na(total_guests_intercept) & is.na(total_guests_intercept_r2) & !is.na(total_guests_intercept_r1) ~ (hotel_guests*total_guests_slope_r1) + total_guests_intercept_r1,
