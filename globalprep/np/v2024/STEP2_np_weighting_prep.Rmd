---
title: 'Natural Products: weighting data prep'
...
write.csv(harvest_tonnes_usd_values_gf, here(current_np_dir, "int", "harvest_tonnes_usd_weighting_gf.csv"), row.names = FALSE)
...
#save this df
write.csv(weighting_usd_values_final, here(current_np_dir, "int", "harvest_weighting_values.csv"), row.names = FALSE)
