...
foragefish_list <- readr::read_csv(here(current_np_dir, "int", "master_taxa_list_SAUP.csv"))
...
write_csv(forage_fish_no_saup, here(current_np_dir, "int", "forage_fish_not_in_SAUP.csv"))
...
write_csv(catch_fishfeed, here(current_np_dir, "int", "saup_catch_forage_fish.csv"))
