...
**Reference**:\
<http://www.fao.org/fishery/statistics/software/fishstatj/en#downlApp> FAO Global Aquaculture Production Quantity 1950_2022 FAO metadata found [here](http://www.fao.org/fishery/statistics/global-aquaculture-production/en)
...
mar_flags <- mar %>% 
  select(-paste0("1950":latest_year)) %>% 
...
# ---- using fao_online_portal_clean.R function ----
...
# species_list_fix <- read_csv(here("globalprep", "mar", "v2023", "raw", "species_list.csv")) %>% 
#   dplyr::select(-1)
# 
# write_csv(species_list_fix, here("globalprep", "mar", "v2023", "raw", "species_list.csv"))
# 
# 
# species_list_fix_24 <- read_csv(here("globalprep", "mar", "v2024", "raw", "species_list.csv")) %>% 
#   dplyr::select(-1)
# 
# write_csv(species_list_fix_24, here("globalprep", "mar", "v2024", "raw", "species_list.csv"))
