...
seaweed_st_rolling <- mar_sw_sust_tonnes %>%
  ...
  dplyr::select(rgn_id, year, tonnes, sust_tonnes, sust_tonnes_orig)
...
readr::write_csv(seaweed_relative_sust_tonnes, here(current_np_dir, "output", "np_relative_sust_tonnes_seaweeds.csv"))
```
