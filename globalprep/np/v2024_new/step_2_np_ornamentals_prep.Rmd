...
# note: 2150 -- 495 after filtering!!! [COME BACK] NAs in exposure, 1655 -- NONE?? NAs in risk 
# (and 1655  -- NO NAS NOW?? in sustainability, since we took the mean and set na.rm = TRUE) 
...
# 1747 -- now only 92 --  [[[COME BACK]]]  NAs in sust_harvest ~~ v2024
```
...
readr::write_csv(orn_relative_sust_tonnes, here(current_np_dir, "output", "np_relative_sust_tonnes_ornamentals.csv"))
```
