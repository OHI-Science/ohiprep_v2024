...
def download_dataset(cms_dir):
    # check that the cms_dir folder exists
    os.makedirs(cms_dir, exist_ok=True)

    # make the current working directory the cms_dir folder, defined above in an r chunk
    os.chdir(cms_dir)

    # download the data using python API, taken from CMS site
