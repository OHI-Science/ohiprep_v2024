...
Considering that the "date updated" listed on the data website (https://acdisc.gesdisc.eosdis.nasa.gov/data/Aura_OMI_Level3/OMUVBd.003/) has stayed consistent (hasn't been updated after the 2023 data was downloaded last year) I am assuming that the methodology hasn't changed (otherwise they would show that the "date updated" was a more recent date). Thus, I can go ahead and continue downloading data starting after May 2nd, 2023.
