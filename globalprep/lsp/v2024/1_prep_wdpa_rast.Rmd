...
# got an error saying "test_area_previous does not contain data"... the previous steps worked and the wdpa_poly_all_previous object does contain data, so that means that this area just doesn't have data...
