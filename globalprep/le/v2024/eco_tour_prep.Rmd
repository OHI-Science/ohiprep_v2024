...
-   create coastal subsets for (1) Hong Kong + Macao, (2) China, (3) no China, HK, or Macao
-   drop "year" column, see if this works for joining subsets. If not, create new years df, apply to coastal subset so that multiplier is copied along range of years for each country.
...
-   join (3) no China, HK, or Macao coastal proportion subset with non-China (which is also non-USA) tourism value subset
-   prep + implement multiplier to get coastal tourism value
