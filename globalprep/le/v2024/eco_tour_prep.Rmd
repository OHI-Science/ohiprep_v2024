...
# make subset that doesn't contain China or United States
filtered_tourism_value <- nc_tourism_value %>% 
  dplyr::filter(rgn_name != "United States") # drop United States (we have separate data for it)

# join with tourism value subset
coastal_subset_tour <- dplyr::full_join(filtered_tourism_value, coastal_rgns_prep,
