...
- if it is %rural and %urban OF coastal pop, combine counts, divide by total pop (from another df? -- check in with Mel about commonly used ones since UN data seems to always have lots of gaps and not all of the regions)
