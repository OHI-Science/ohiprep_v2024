...
Now we can join these newly created China & Macao + Hong Kong coastal tourism value data frames. Then, we'll run `name_2_rgn` and aggregate values to get combined tourism values for China as an OHI region. We'll call this `china_agg`.
