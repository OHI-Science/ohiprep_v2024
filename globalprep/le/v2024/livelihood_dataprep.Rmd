...
(put this within previous chunk, read in data etc. for number of tourism jobs, join wiht labor_regions, make new proportion of tourism jobs column, group by year, do prelim plotting etc. and evaluate data quality etc.)
