...
eco_mar_usd_raw_cut <- eco_mar_usd_raw %>% 
  filter(!rgn_name %in% c("Yemen", "Uruguay", "Togo", "Sint Eustacius", "Seychelles", "Qatar", "Puerto Rico and Virgin Islands of the United States", "Poland", "Libya", "Jordan", "Falkland Islands", "Estonia", "Dominica", "Curacao", "Cape Verde"))
