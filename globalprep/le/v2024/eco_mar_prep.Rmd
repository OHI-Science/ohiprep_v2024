...
```{r}
# Doing some final data prep so that we have both the raw gapfilled data as well as the oen that we're writing out 
...
# write_csv(eco_mar_usd_write, here::here(data_path, "int", "eco_mar_usd_pre.csv"))
```
