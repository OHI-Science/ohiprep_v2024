...
## v2024 doesnt show gaps for specific years?? but gf_counts are really low: avg is 1.02 and max is 16
...
###for the population question, they only use total country population from World Development Indicators to create weighted averages of sanitation proportion since there are more regions in the sanitation data set than OHI regions-but the actual sanitation proportion is multiplied by population density within 25 mi of the coast- however this dataset is not correct and needs to be changed(for example fiji's coastal population in this dataset is higher than the total population of fiji which is obviously not right)

```{r, results="hide", message = FALSE, warning = FALSE, eval=FALSE}

# Population within 25 miles of coastline - v2021; last updated in 2021
## Population within 25 miles of coastline - v2024; last updated in 2023 data last uploaded in 2020
...
##not changing this for 2024 yet cuz i am scared
...
##total country population was only used to find the sanitation access proportion by _ sanitation percentage by population to get a proportion from 0-1, this was multiplied by 25 miles from shore population density to get coastal population's density sanitation access
