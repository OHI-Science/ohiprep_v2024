...
*Therefore, you cannot say exactly that there are more fish being caught in a cell near the equator than a cell near antarctica, since the cell area may be smaller and therefore there would be less fish within that cell already.*
...
*The issue here is related to how area and values are preserved (or not preserved) during map projections. Mollweide preserves equal-area, but that means that cell size changes. *
